...
<ul id="myTab" class="nav nav-tabs">
  ...
  <li class="active"><a href="#firstg" data-toggle="tab">First Grading</a></li>

    @if($grade->second_grading===null)
    @else

  <li class=""><a href="#secondg" data-toggle="tab">Second Grading</a></li>
  @endif

   @if($grade->third_grading===null)
    @else

  <li class=""><a href="#thirdg" data-toggle="tab">Third Grading</a></li>
   ...
   @if($grade->fourth_grading===null)
    @else
  <li class=""><a href="#fourthg" data-toggle="tab">Fourth Grading</a></li>
...
<div id="myTabContent" class="tab-content">
  <div class="tab-pane fade active in" id="firstg">
                    ...
                    <div class="col-md-12">
                        ...
                        {{csrf_field()}}
                            <div class="form-group">
                                <input type="text" id="first" name="first" class="form-control" placeholder="First Grading" value="{{$grade->first_grading}}"  readonly>
                            </div>
  ...
  <div class="tab-pane fade" id="secondg">
                        ...
                        <form method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="second" class="form-control" placeholder="Second Grading" value="{{$grade->second_grading}}" >
                            </div>
                            <button class="btn btn-info">UPDATE</button>
                        </form>                        
                    
  </div>
   <div class="tab-pane fade" id="thirdg">
                     
                     <form method="post">
                        {{csrf_field()}}
                            <div class="form-group">
                                <label for="third">Third Grading</label>
                                <input type="text" name="third" class="form-control" placeholder="Third Grading" value="{{$grade->third_grading}}" >
                            </div>
                            <button class="btn btn-info">UPDATE</button>
                        </form>
                
  </div>
  <div class="tab-pane fade" id="fourthg">
                  
                        <form method="post">
                        {{csrf_field()}}
                            <div class="form-group">
                                <label for="fourth">Fourth Grading</label>
                                <input type="text" name="fourth" class="form-control" placeholder="Fourth Grading" value="{{$grade->fourth_grading}}" >
                            </div>
                            <button class="btn btn-info">UPDATE</button>
                        </form>                        
