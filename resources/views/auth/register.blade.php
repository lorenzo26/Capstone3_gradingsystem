        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
             <ul class="nav nav-tabs" role="tablist">
                <li class="active"><a href="/register">Teacher</a></li>
                <li><a href="/register_student">Student</a></li>
            </ul>
                <div class="panel-heading">Register for Teacher</div>
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                         ...
                         <input id="role" type="hidden" class="form-control" name="role" value="Teacher" required autofocus>
